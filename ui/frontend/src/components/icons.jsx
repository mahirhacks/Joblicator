export function IconProfile() {
  return (
    <svg viewBox="0 0 20 20" fill="none" aria-hidden="true">
      ...
      <path d="M4.5 16.5c0-3 2.5-5 5.5-5s5.5 2 5.5 5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconReview() {
  return (
    <svg viewBox="0 0 20 20" fill="none" aria-hidden="true">
      <path d="M5 4.5h10M5 8.5h7M5 12.5h8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M14 12.5l2 2 3.5-4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function IconFile() {
  return (
    <svg viewBox="0 0 16 16" fill="none" aria-hidden="true">
      <path d="M4 2.5h5l3.5 3.5V13a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1z" stroke="currentColor" strokeWidth="1.25" />
      <path d="M9 2.5V6h3.5" stroke="currentColor" strokeWidth="1.25" />
    </svg>
  );
}
...
export function IconExternal() {
  return (
    <svg viewBox="0 0 16 16" fill="none" aria-hidden="true">
      <path d="M6 3.5h6.5V10M9.5 6.5L3 13" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" />
    </svg>
  );
}
